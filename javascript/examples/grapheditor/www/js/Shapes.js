...
//		var tp = mxUtils.getValue(this.style, 'tabPosition', this.tabPosition);
	...
	// Reversed And
	function ReversedAndShape()
	{
		mxActor.call(this);
	};
	mxUtils.extend(ReversedAndShape, mxActor);

	ReversedAndShape.prototype.redrawPath = function(c, x, y, w, h)
	{
		c.moveTo (w, 0)
		c.quadTo(0, 0, 0, h / 2)
		c.quadTo(0, h, w, h)
	...
	mxCellRenderer.registerShape('reversedand', ReversedAndShape);
	...
	ReversedAndShape.prototype.constraints = [new mxConnectionConstraint(new mxPoint(0.175, 0.25), false),
									new mxConnectionConstraint(new mxPoint(0.25, 0.5), false),
									new mxConnectionConstraint(new mxPoint(0.175, 0.75), false),
									new mxConnectionConstraint(new mxPoint(1, 0.9), false),
									new mxConnectionConstraint(new mxPoint(0.7, 0.1), false),
									new mxConnectionConstraint(new mxPoint(0.7, 0.9), false)];
