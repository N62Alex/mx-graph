...
Sidebar.prototype.init = function()
{
	...
	this.setCurrentSearchEntryLibrary('testlib');
	this.addStencilPalette('testlib', mxResources.get('testlib'), dir + '/testlib.xml',
		';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	this.setCurrentSearchEntryLibrary();
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
		...
		this.createVertexTemplateEntry('shape=reversedand;whiteSpace=wrap;html=1;', 60, 80, '', 'Reversed And', null, null, 'logic and'),
